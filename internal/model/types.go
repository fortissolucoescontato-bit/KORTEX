...
// SupportTier indicates how fully an agent supports the Kortex AI ecosystem.
...
const (
	...
	ComponentKortexCLI        ComponentID = "kortex"
...
const (
	PersonaKortex PersonaID = "carbon"
...
const (
	// StrategyMarkdownSections uses <!-- kortex:ID --> markers to inject sections
...
const (
	PresetFullKortex PresetID = "full-carbon"
