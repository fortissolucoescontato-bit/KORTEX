...
description: >
  ...
  "iniciar sdd", or wants to bootstrap SDD persistence (kortex-engram, openspec, or hybrid) for the
...
2. Initialize the persistence backend (kortex-engram, openspec, or hybrid — per user preference)
