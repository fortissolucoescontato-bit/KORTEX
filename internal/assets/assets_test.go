...
func TestAllEmbeddedAssetsAreReadable(t *testing.T) {
	expectedFiles := []string{
		...
		// Kimi agent files
		"kimi/persona-carbon.md",
		"kimi/output-style-carbon.md",
		"kimi/sdd-orchestrator.md",
		"kimi/KIMI.md",
		"kimi/agents/carbon.yaml",
...
func TestOpenCodeEmbeddedAssetLayout(t *testing.T) {
	...
	for _, name := range []string{"commands", "plugins", "persona-carbon.md", "sdd-orchestrator.md", "sdd-overlay-single.json", "sdd-overlay-multi.json"} {
		if !seen[name] {
...
func TestClaudeEmbeddedAssetLayout(t *testing.T) {
	...
	for _, name := range []string{"commands", "engram-protocol.md", "persona-carbon.md", "sdd-orchestrator.md"} {
		if !seen[name] {
...
func TestKortexLanguageInstructionsDoNotBiasEnglishSessions(t *testing.T) {
	personaPaths := []string{
		"claude/persona-carbon.md",
		"generic/persona-carbon.md",
		"kiro/persona-carbon.md",
		"kimi/persona-carbon.md",
		"opencode/persona-carbon.md",
	}
...
func TestEmbeddedAssetCount(t *testing.T) {
	...
	for _, entry := range entries {
		...
		if entry.Name() == "_shared" {
			for _, sharedFile := range []string{"persistence-contract.md", "engram-convention.md", "kortex-convention.md", "openspec-convention.md", "sdd-phase-common.md", "skill-resolver.md"} {
