...
var mvpComponents = []Component{
	{ID: model.ComponentKortexEngram, Name: "kortex-engram", Description: "Memória persistente entre sessões (Nexo-Fortis)"},
	...
	{ID: model.ComponentPersona, Name: "Persona", Description: "Kortex, neutral or custom behavior"},
	{ID: model.ComponentPermission, Name: "Permissions", Description: "Security-first defaults and guardrails"},
	{ID: model.ComponentKortexCLI, Name: "Kortex CLI", Description: "Kortex Guardian Angel — AI provider switcher"},
	{ID: model.ComponentTheme, Name: "Theme", Description: "Kortex Carbon theme overlay (future)"},
}
