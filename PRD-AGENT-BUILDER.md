...
**Date**: 2026-04-03
**Status**: Draft
**Parent PRD**: [PRD.md](PRD.md) (Kortex AI Installer)

---

## 1. Problem Statement

The Kortex AI ecosystem ships with a powerful set of pre-built skills and SDD phases. But every developer works differently. A frontend architect needs a design system reviewer. A security engineer needs a vulnerability scanner agent. A technical writer needs a documentation generator.
...
```
You are an expert AI skill creator for the Kortex AI ecosystem.
...
```
~/.config/kortex/custom-agents.json
```
...
graph TB
    ...
    subgraph STORAGE["Storage"]
        ...
        REGISTRY_FILE["~/.config/kortex/custom-agents.json"]
